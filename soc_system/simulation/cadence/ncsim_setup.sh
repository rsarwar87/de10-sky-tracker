...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/media/rsarwar/4ca9736b-e552-4ce5-810d-70f97fc8ed6c/altera_2018.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/alt_vip_vfr_hdmi/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/soc_system_alt_vip_vfr_hdmi.vo"                          -work alt_vip_vfr_hdmi                 -cdslib ./cds_libs/alt_vip_vfr_hdmi.cds.lib                
